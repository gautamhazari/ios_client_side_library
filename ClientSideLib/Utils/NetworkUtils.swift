...
//                }
    ...
    static func requestConstructor(msisdn: String? = nil, mcc: String? = nil, mnc: String? = nil, sourceIp: String? = nil, subId: String? = nil, scope: String? = nil, version: String? = nil, discovery: String? = nil)-> [String : String] {
